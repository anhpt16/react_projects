...
export const Header = () => {
  ...
  const toggleMenu = () => {
    if (lockMenu.current) return;
    lockMenu.current = true;
    setHidden((prev) => !prev);
    setTimeout(() => {
      lockMenu.current = false;
    }, 200);
  }
    ...
    <header>
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
          ...
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <span className="self-center text-2xl font-medium whitespace-nowrap dark:text-white">Cinemate</span>
          </Link>
          <div className="flex md:order-2">

            <button onClick={() => setDarkMode(!darkMode)} id="theme-toggle" type="button" className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 border border-slate-100 mr-2.5 rounded-lg text-sm p-2">
                {darkMode 
            ...
            <button onClick={toggleMenu} type="button" aria-controls="navbar-search" aria-expanded="false" className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1">
